...
As Lean and the mathematical library becomes more capable, some mathematicians decide to get attention by coding the latest mathematical concepts and proof into Lean, to show that Lean was capable of showing that the latest proofs were valid. This gets the attention of top mathematicians like Terence Tao, who used Lean, liked what it is capable of, and advocate for its use.

In the present day, AI systems and Lean are now working in tandem to advance the field of mathematics. Mathematical concepts and proofs are generated by AIs, who then use Lean to provide feedback on whether the proof are correct or not. The feedback is then used to correct and generate more proofs. Mathematicians oversee the process to ensure that the proofs are of use and to add new ideas to the cycle for processing.
